...
public class SyntaxUpdateTest implements Runnable
{
    static int count = 0 ;
    final boolean expectLegalSyntax ;
    final ManifestEntry testEntry ;

    public SyntaxUpdateTest(ManifestEntry entry, Syntax defSyntax, boolean positiveTest) {
        testEntry = entry;
