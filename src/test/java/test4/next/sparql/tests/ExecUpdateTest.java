...
public class ExecUpdateTest implements Runnable
{
...
//    public static ExecUpdateTest create(String testName, EarlReport earl, Resource entry, Resource action, Resource result)
//    {
...
//            return null ;
//        }
//        return new ExecUpdateTest(testName, earl, entry, action, result) ;
//
//    }
//    private ExecUpdateTest(String testName, EarlReport earl, Resource entry, Resource action, Resource result)
//    {
...
//    }
    ...
    public ExecUpdateTest(ManifestEntry entry) {
    ...
    public void run() {
        ...
        Dataset input = getDataset(testEntry.getAction()) ;
        Dataset output = getDataset(testEntry.getResult()) ;
    ...
    static Dataset getDataset(Resource r)
    {
        ...
        for ( String x : dftData )
            T.parser(x).parse(ds.getDefaultModel());
