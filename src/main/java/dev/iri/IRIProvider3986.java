...
public class IRIProvider3986 implements IRIProvider {
    ...
    // Default to to throw exceptions
    //static { org.seaborne.rfc3986.IRISys.setErrorHandler(errHandler); }
    ...
    public void strictMode(String scheme, boolean runStrict) {
        if ( scheme.equals("urn") )
            SystemIRI3986.URN_SCHEME = strictness(runStrict);
        if ( scheme.equals("file") )
            SystemIRI3986.FILE_SCHEME = strictness(runStrict);
    }
