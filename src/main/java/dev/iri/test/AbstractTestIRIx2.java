...
import dev.iri.IRIProvider3986;
...
public class AbstractTestIRIx2 {
    ...
    public static Iterable<Object[]> data() {
        ...
        //data.add(new Object[]{"Any", new IRIProviderAny()});
    ...
    protected AbstractTestIRIx2(String name, IRIProvider provider) {
