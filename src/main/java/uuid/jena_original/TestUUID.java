...
import static uuid.jena_original.TS_UUID.factory1;
import static uuid.jena_original.TS_UUID.factory4;
...
public class TestUUID extends TestCase
{
    ...
    public void testTime1()
    {
        ...
        assertTrue(u.getVersion() == UUID_V1.UUID_ImplVersion) ;
        assertTrue(u.getVariant() == 2) ;
    }
    ...
    public void testRandom1()
    {
        ...
        assertTrue(u.getVersion() == UUID_V4.UUID_ImplVersion) ;
        assertTrue(u.getVariant() == 2) ;
    }
