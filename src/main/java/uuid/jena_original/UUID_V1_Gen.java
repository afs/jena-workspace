...
import uuid.jena_original.JenaUUID.UUIDFormatException;
...
public class UUID_V1_Gen implements UUIDFactory
{
    ...
    // 2 bits variant = 10, 14 bits clock seq and 48 bits network node
    ...
    private void setTime() {
        ...
        // Milli to micro conversion. Java8.
        time = time*1000;
...
//        time = time*1000;
//        // Time in micro seconds since the Linux epoch.
//        time = seconds*1_000_000 + micro;
    ...
    private void setInitialState() {
        ...
        // Less that 14 bits can be useful to get a characteristic "-80??-" in the
        // string
        clockSeq = 0;
        if ( CLOCK_BITS != 0 )
