...
//            return null;
    ...
    */
    ...
    // Intercept of passthrough.
    static Iterator<BindingNodeId> stepOne(Iterator<BindingNodeId> chain, Node graphNode, Triple tPattern, NodeTable nodeTable, ExecutionContext execCxt) {
//        if ( ! RX_tripleHasNodeTriple(tPattern) || tPattern.isConcrete() )
//            // XXX WRONG.
//            return chain;
        // The scan.
        Function<BindingNodeId, Iterator<BindingNodeId>> step = bnid -> {
            Node g = RX_nodeTopLevel(graphNode);
            ...
            // XXX See StageMatchTuple.access. Filter and anyGraphs

            DatasetGraph dsg = execCxt.getDataset();
            Iterator<Quad> dsgIter = dsg.find(g, s, p, o);

            //dsgIter = Iter.log(dsgIter);
