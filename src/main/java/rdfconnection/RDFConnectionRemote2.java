...
public class RDFConnectionRemote2 implements RDFConnection {
    ...
    final String svcUpdate;
    final String svcGraphStore;
    
    Transactional txnLifecycle;
     ...
     */
    static RDFConnectionRemote2 modify(RDFConnectionRemote2 base, HttpClient httpClient, HttpContext httpContext, String destination, String sQuery, String sUpdate, String sGSP) {
        ...
        return new RDFConnectionRemote2(base.txnLifecycle, httpClient, httpContext, destination, sQuery, sUpdate, sGSP);
    }
    ...
    protected String acceptSelectHeader = QueryEngineHTTP.defaultSelectHeader();
    protected String acceptAskHeader = QueryEngineHTTP.defaultAskHeader();
    protected String acceptRDFHeader = QueryEngineHTTP.defaultConstructHeader();
    ...
    public RDFConnectionRemote2(HttpClient httpClient, HttpContext httpContext, String destination, String sQuery, String sUpdate, String sGSP) {
    ...
    /*package*/ RDFConnectionRemote2(Transactional txnLifecycle, HttpClient httpClient, HttpContext httpContext, String destination, String sQuery, String sUpdate, String sGSP) {
        this.httpClient = httpClient;
        this.httpContext = httpContext;
        this.destination = destination;
        this.svcQuery = RDFConn.formServiceURL(destination, sQuery);
