 ...
 */
public class RDFConnectionRemote3 implements RDFConnection {
    ...
    /**
     * Create an {@code RDFConnectionRemote} based on an existing one, with modifications  
     */
    static RDFConnectionRemote3 modify(RDFConnectionRemote3 base, HttpClient httpClient, HttpContext httpContext, String destination, String sQuery, String sUpdate, String sGSP) {
        Objects.requireNonNull(base);
        httpClient  = dft(httpClient, base.httpClient);
        httpContext = dft(httpContext, base.httpContext);
        destination = dft(destination, base.destination);
        sQuery      = dft(sQuery, base.svcQuery);
        sUpdate     = dft(sUpdate, base.svcUpdate);
        sGSP        = dft(sGSP, base.svcGraphStore);
        return new RDFConnectionRemote3(base.txnLifecycle, httpClient, httpContext, destination, sQuery, sUpdate, sGSP);
    }
    ...
    static class Builder {
        ...
        Builder(String destination, String sQuery, String sUpdate, String sGSP) {
        ...
        Builder(RDFConnectionRemote3 base) {
            Objects.requireNonNull(base);
        ...
        public RDFConnectionRemote3 build() {
            requireNonNull(txnLifecycle);
            requireNonNull(destination);
            return new RDFConnectionRemote3(txnLifecycle, httpClient, httpContext, destination, sQuery, sUpdate, sGSP);
        }
    }
    
    private static <T> T dft(T obj1, T obj2) {
    ...
    public RDFConnectionRemote3(HttpClient httpClient, String destination) {
        this(httpClient,
             requireNonNull(destination),
             fusekiDftSrvQuery, 
             fusekiDftSrvUpdate,
    ...
    public RDFConnectionRemote3(String destination) {
    ...
    public RDFConnectionRemote3(String sQuery, String sUpdate, String sGSP) {
        this(null, sQuery, sUpdate, sGSP);
    }
    
    /** Create connection, using URL of the dataset and names for the services. 
     *  Short names are expanded against the destination.
     *  Absolute URIs are left unchanged.
     */
    public RDFConnectionRemote3(String destination, String sQuery, String sUpdate, String sGSP) {
     ...
     *  Absolute URIs are left unchanged.
     */
    public RDFConnectionRemote3(HttpClient httpClient, String destination, String sQuery, String sUpdate, String sGSP) {
        this(httpClient, null, destination, sQuery, sUpdate, sGSP);
    }
    
    /** Create connection, using URL of the dataset and short names for the services */
    public RDFConnectionRemote3(HttpClient httpClient, HttpContext httpContext, String destination, String sQuery, String sUpdate, String sGSP) {
    ...
    private RDFConnectionRemote3(Transactional txnLifecycle, HttpClient httpClient, HttpContext httpContext, String destination, String sQuery, String sUpdate, String sGSP) {
        this.httpClient = httpClient;
        this.httpContext = httpContext;
        this.destination = destination;
        this.svcQuery = RDFConn.formServiceURL(destination, sQuery);
