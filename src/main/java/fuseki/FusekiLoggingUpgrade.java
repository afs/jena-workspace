 ...
 * This version does not discover the loggin provider - it is coded in  
 */
...
public abstract class FusekiLoggingUpgrade
{
    ...
    private static FusekiLoggingUpgrade loggingProvider = new FusekiLoggingLog4j() ;
    ...
    static class FusekiLoggingLog4j extends FusekiLoggingUpgrade {
        ...
        protected void loggingSetup() {
            ...
            if ( attemptLog4j(fn1) ) return ; 
            if ( attemptLog4j(fn2) ) return ;
        ...
        private static boolean attemptLog4j(String fn) {
            if ( fn == null )
                return false ;
            try {
                File f = new File(fn) ;
