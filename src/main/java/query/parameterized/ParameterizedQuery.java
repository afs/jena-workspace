...
public class ParameterizedQuery {
    ...
    /** Create a new query with occurrences of specific variables replaced by the given node value from the Map.
     * @param query Query
     ...
     * @return Query, with replacements
     */
    public static Query parameterizeIncludeMapped(Query query, Map<Var, Node> map) {
        ...
        if ( q2.isQueryResultStar() ) {
            // SELECT *
            // Calculate correct
            // This should not include substituted variables.
