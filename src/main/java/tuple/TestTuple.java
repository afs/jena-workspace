...
public class TestTuple {
    ...
    @Test public void tuple_not_equals_1() {
        Tuple<Integer> tuple1 = TupleFactory.create(9,8,7) ;
        Tuple<Integer> tuple2 = TupleFactory.create(7,8,9) ;
    ...
    @Test public void tuple_not_equals_2() {
        Tuple<Integer> tuple1 = TupleFactory.create(9,8,7) ;
        Tuple<Integer> tuple2 = TupleFactory.create(9,8) ;
        assertNotEquals(tuple1.hashCode(), tuple2.hashCode()) ;
        assertNotEquals(tuple1, tuple2) ;
    }
    ...
    private void check(Tuple<Integer> tuple) {
        ...
        Tuple<Integer> tuple2 = TupleFactory.createTuple(list2) ;
        assertEquals(tuple.hashCode(), tuple2.hashCode()) ;
        assertEquals(tuple, tuple2) ;
        
        // Other constructors
        List<Integer> list3 = new ArrayList<>(list) ;
        Tuple<Integer> tuple3 = TupleFactory.createTuple(list3.toArray(new Integer[0])) ;
