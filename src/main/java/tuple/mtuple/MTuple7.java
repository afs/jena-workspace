...
class MTuple7<X> extends MTupleBase<X> {
    protected X x1 = null;
    protected X x2 = null;
    protected X x3 = null;
    protected X x4 = null;
    ...
    public MTuple7(X x1, X x2, X x3, X x4, X x5, X x6, X x7) {
        this.x1 = x1 ;
        this.x2 = x2 ;
        this.x3 = x3 ;
        this.x4 = x4 ;
    ...
    public Tuple7<X> tuple() {
        return TupleFactory.create7(x1, x2, x3, x4, x5, x6, x7);
    }
