...
public class MimeType {
    ...
    public static void main(String...args) {
        String[] strings = { //"text/plain",
                             //"text/plain;q=0.5",
                             //"text/plain;foo=\"alpha\"",
                             //"text/plain;q=0.5;foo=\"alpha\"",
                             //"text/plain;q=0.5;foo=\"al pha\"",
                             "t/s;foo=\"a b\""
                             };
    ...
    private interface Parameter { void parameter(int startAttribute, int endAttribute, int startValue, int endValue); }
    ...
    public List<Pair<String, String>> getParameters() {
        ...
        parseParameters(startParameters, (a0, a1, v0, v1)->{
                            ...
                            params.add(Pair.create(attr,  val));
                        });
        return params;
    }
    ...
    public String toString() {
        ...
        if ( hasParameters() ) {
            List<Pair<String, String>> x = getParameters();
            x.forEach(p->{
                sb.append(';');
                sb.append(p.getLeft());
                sb.append('=');
    ...
    private int parseParameters(int idx, Parameter handler) {
        // parameters
