...
public class ElementWalker {
    ...
    public static void walk(Element el, ElementVisitor elVisitor, ExprVisitor exprVisitor) {
        Walker w = new Walker(elVisitor, exprVisitor) ;
        el.visit(w) ;
    }
...
//    }
    ...
    static public class Walker implements ElementVisitor, ExprVisitorFunction {
        protected final ElementVisitor elementVisitor ;
        protected final ExprVisitor exprVisitor ;

        protected Walker(ElementVisitor visitor, ExprVisitor exprVisitor) {
