...
public class BufferingDatasetGraph0 extends DatasetGraphBase implements BufferingCtl {

    private DatasetGraph base;
    protected DatasetGraph get() { return base; }
    ...
    public BufferingDatasetGraph0(DatasetGraph dsg) {
        base = dsg;
    }
