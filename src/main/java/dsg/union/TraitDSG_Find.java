...
import static dsg.union.DSG_ImplLib.isWildcard;
...
public interface TraitDSG_Find {
     ...
     */
    public abstract Iterator<Quad> findInDftGraph(Node s, Node p , Node o) ;
     ...
     */
    public default Iterator<Triple> findInUnionGraph(Node s, Node p , Node o) {
     ...
     */
    public default Iterator<Quad> findQuadsInUnionGraph(Node s, Node p , Node o) {
    ...
    public abstract Iterator<Quad> findInSpecificNamedGraph(Node g, Node s, Node p , Node o) ;
     ...
     */
    public abstract Iterator<Quad> findInAnyNamedGraphs(Node s, Node p , Node o) ;
