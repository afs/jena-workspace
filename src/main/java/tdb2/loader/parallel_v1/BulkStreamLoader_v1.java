...
public class BulkStreamLoader_v1 implements StreamRDF, BulkStreamRDF {
    ...
    public BulkStreamLoader_v1(DatasetGraph dsg, MonitorOutput output) {
    ...
    public void finishBulk() {
        ...
        // Phase 2.
        ProgressMonitorOutput monitor2 = new ProgressMonitorOutput("Indexing", LoaderParallel_v1.IndexTickPoint, LoaderParallel_v1.IndexSuperTick, output);
...
//        }
    ...
    private void playIndex(TupleIndex idx, ProgressMonitorOutput progress) {
        Journal journal = Journal.create(Location.mem());
        TransactionCoordinator coordinator = new TransactionCoordinator(journal);
        coordinator.add(idxBTree(idx));
        coordinator.start();
