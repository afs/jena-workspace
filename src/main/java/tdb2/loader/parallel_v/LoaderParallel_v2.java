 ...
 * <b>UNUSED</b>
 * <p>
 * Original code for the parallel loader.<br/>
 * Superceded by {@link LoaderMain} running with {@link LoaderPlans#loaderPlanParallel}.<br/>
 * Retain until confimred LoaderMain+parallel plan is as fast.
 * <hr>
 * <p>
 * The parallel Loader. 
 * <p>
 ...
 * </blockquote>
 * <p>
 * {@link DataBatcher} produces {@link DataBlock}s - groupings of triples and quads and sends them to a handler {@code Consumer<DataBlock>}. 
 ...
 */
public class LoaderParallel_v2 extends LoaderBase implements DataLoader {
...
//    public static final int IndexSuperTick  = 10;
    ...
    public LoaderParallel_v2(DatasetGraph dsg, MonitorOutput output) {
        this(dsg, null, output);
    }
    
    public LoaderParallel_v2(DatasetGraph dsg, Node graphName, MonitorOutput output) {
