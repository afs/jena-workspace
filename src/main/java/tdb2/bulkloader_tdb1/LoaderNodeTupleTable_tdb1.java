...
public class LoaderNodeTupleTable_tdb1 implements Closeable, Sync
{
    private LoadMonitor_tdb1 monitor          = null ;
    ...
    public LoaderNodeTupleTable_tdb1(NodeTupleTable nodeTupleTable, String itemsName, LoadMonitor_tdb1 monitor)
    {
    ...
    {
        BuilderSecondaryIndexes_tdb1 builder = new BuilderSecondaryIndexesSequential_tdb1(monitor) ;
...
//            builder = new BuilderSecondaryIndexesSequential(printer) ;
    ...
    static void copyIndex(Iterator<Tuple<NodeId>> srcIter, TupleIndex[] destIndexes, String label, LoadMonitor_tdb1 monitor)
    {
