...
public final class LoadMonitor_tdb1
{
    ...
    private final long superTick = BulkLoader_tdb1.superTick ;
    ...
    public LoadMonitor_tdb1(DatasetGraph dsg, Logger log, String itemsName,
                       long dataTickPoint,  
                       long indexTickPoint)
    {
        this.dataset = dsg ;
    ...
    {
        EventManager.send(dataset, new Event(BulkLoader_tdb1.evStartBulkload, null)) ;
        timer.startTimer() ;
    ...
    public void finishLoad()
    {
        ...
        EventManager.send(dataset, new Event(BulkLoader_tdb1.evFinishBulkload, null)) ;
    }
    ...
    public void startDataPhase()
    {
        ...
        currentItems = 0 ;
        totalDataItems = 0 ;
        EventManager.send(dataset, new Event(BulkLoader_tdb1.evStartDataBulkload, null)) ;
    }
    
    public void finishDataPhase()
    {
        EventManager.send(dataset, new Event(BulkLoader_tdb1.evFinishDataBulkload, null)) ;
    ...
    public void startIndexPhase()    
    {
        ...
        currentItems = 0 ;
        EventManager.send(dataset, new Event(BulkLoader_tdb1.evStartIndexBulkload, null)) ;
    }

    public void finishIndexPhase()
    {
        EventManager.send(dataset, new Event(BulkLoader_tdb1.evFinishIndexBulkload, null)) ;
