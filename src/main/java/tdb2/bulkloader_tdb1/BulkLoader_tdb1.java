...
public class BulkLoader_tdb1 {
    ...
    public static LoadMonitor_tdb1 createLoadMonitor(DatasetGraphTDB dsg, String itemName, boolean showProgress) {
        if ( showProgress )
            return new LoadMonitor_tdb1(dsg, loadLogger, itemName, DataTickPoint, IndexTickPoint) ;
        else
            return new LoadMonitor_tdb1(dsg, null, itemName, DataTickPoint, IndexTickPoint) ;
    }
    ...
    private static final class DestinationDSG implements BulkStreamRDF {
        ...
        final private LoadMonitor_tdb1          monitor1 ;
        final private LoadMonitor_tdb1          monitor2 ;
        final private LoaderNodeTupleTable_tdb1 loaderTriples ;
        final private LoaderNodeTupleTable_tdb1 loaderQuads ;
        ...
        DestinationDSG(final DatasetGraphTDB dsg, boolean showProgress, boolean collectStats) {
            ...
            loaderTriples = new LoaderNodeTupleTable_tdb1(dsg.getTripleTable().getNodeTupleTable(), "triples", monitor1) ;
            loaderQuads = new LoaderNodeTupleTable_tdb1(dsg.getQuadTable().getNodeTupleTable(), "quads", monitor2) ;
    ...
    private static final class DestinationGraph implements BulkStreamRDF {
        ...
        final private LoadMonitor_tdb1          monitor ;
        final private LoaderNodeTupleTable_tdb1 loaderTriples ;
        final private boolean              startedEmpty ;
        private long                       count = 0 ;
        private StatsCollector             stats = null ;
        ...
        DestinationGraph(final DatasetGraphTDB dsg, Node graphNode, boolean showProgress, boolean collectStats) {
            ...
            loaderTriples = new LoaderNodeTupleTable_tdb1(nodeTupleTable, "triples", monitor) ;
        }
