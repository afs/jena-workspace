 ...
 */
public class ApplyTransformVisitor2 implements OpVisitorByTypeAndExpr, ExprVisitor {
    private final Transform     opTransform;
    private final ExprTransform exprTransform;

    protected final boolean     visitService;
    protected final boolean     visitExpressions;
    ...
    public ApplyTransformVisitor2(Transform opTransform, ExprTransform exprTransform,
                                  boolean visitService,
                                  OpVisitor before, OpVisitor after) {
        this(opTransform, exprTransform, visitService, true, before, after);
    }

    public ApplyTransformVisitor2(Transform opTransform, ExprTransform exprTransform,
                                  boolean visitService,
                                  boolean visitExpressions,
                                  OpVisitor before, OpVisitor after) {
        ...
        this.visitExpressions = visitExpressions;
    }
    ...
    protected Expr transform(Expr expr) {
        ...
        try {
            Walker.walk(expr, this, this, beforeVisitor, afterVisitor);
...
//            return exprList;
    ...
    private <T> T pop(Deque<T> stack) {
        try {
            ...
            if ( true ) throw new RuntimeException("No such element to pop");
