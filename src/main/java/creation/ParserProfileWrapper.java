...
public class ParserProfileWrapper implements ParserProfile {
    ...
    protected ParserProfile get() { return parserProfile ; }  

    public ParserProfileWrapper(ParserProfile other) {
        this.parserProfile = other ;
    }
    ...
    public LabelToNode getLabelToNode() {
        return get().getLabelToNode() ;
    }

    @Override
    public void setLabelToNode(LabelToNode labelToNode) {
        get().setLabelToNode(labelToNode);
    }
    ...
    public Prologue getPrologue() {
        return get().getPrologue() ;
    }

    @Override
    public void setPrologue(Prologue prologue) {
        get().setPrologue(prologue);
    }
