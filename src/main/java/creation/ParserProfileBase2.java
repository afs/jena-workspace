...
public class ParserProfileBase2 implements ParserProfile {
    ...
    protected final FactoryRDF  factory ;
    protected boolean           strictMode = SysRIOT.isStrictMode() ;

    public ParserProfileBase2(Prologue prologue, ErrorHandler errorHandler) {
        this(prologue, errorHandler, SyntaxLabels.createLabelToNode());
    }

    public ParserProfileBase2(Prologue prologue, ErrorHandler errorHandler, LabelToNode labelMapping) {
        this.prologue = prologue;
        this.errorHandler = errorHandler;
        this.labelMapping = labelMapping;
        this.factory = new FactoryRDFStd();
    }
