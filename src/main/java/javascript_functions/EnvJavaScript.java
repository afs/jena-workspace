...
public class EnvJavaScript {
    ...
    public static Symbol symJavaScriptLib = SystemARQ.allocSymbol("javascript-lib");
    /** JavaScript library in a file as named */ 
    public static Symbol symJavaScriptLibFile = SystemARQ.allocSymbol("javascript-library-file");
    ...
    static EnvJavaScript create(Context context) {
